        ...
        <div class="form col-md-6 col-md-offset-2">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('student.register') }}">
                ...
                <div class="form-group{{ $errors->has('enrollment') ? ' has-error' : '' }}">
                    <label for="name" class="col-md-4 control-label">Matrícula</label>

                    <div class="col-md-8">
                        <input id="name" type="text" class="form-control" name="enrollment" value="{{ old('enrollment') }}" required autofocus>
